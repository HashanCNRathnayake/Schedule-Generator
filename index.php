...
<body class="py-4">
  ...
  <script>
    ...
    searchInput?.addEventListener('input', async () => {
      ...
      const res = await fetch('/admin/course/search_courses.php?q=' + encodeURIComponent(q));
    ...
    resultsBox?.addEventListener('click', async e => {
      ...
      const res = await fetch('/admin/course/get_course_details.php?id=' + btn.dataset.id);
